...
use App\Http\Controllers\AppointmentCalendarController as OperationalAppointmentCalendarController;
...
use App\Http\Controllers\FeedbackController as OperationalFeedbackController;
...
Route::middleware(['auth', 'active', 'verified'])->group(function () {
    ...
    Route::middleware('super_admin')
        ...
        ->name('admin.')
        ->group(function () {
            Route::resource('staff', AdminStaffController::class)->only('store');
    ...
    Route::middleware('role:super_admin,admin')
        ...
        ->group(function () {
            ...
            Route::get('/appointments/calendar', OperationalAppointmentCalendarController::class)->name('appointments.calendar');
            ...
            Route::resource('appointments', AdminAppointmentController::class)->only(['index', 'store', 'show', 'update']);
            Route::get('/customers/duplicates', [AdminCustomerController::class, 'duplicates'])->name('customers.duplicates');
            ...
            Route::resource('staff', AdminStaffController::class)->only(['index', 'show', 'edit', 'update']);
            ...
            Route::post('/transactions/{transaction}/payments', [AdminTransactionController::class, 'recordPayment'])->name('transactions.payments.store');
            Route::patch('/transactions/{transaction}/refund', [AdminTransactionController::class, 'refund'])->name('transactions.refund');
            Route::patch('/transactions/{transaction}/void', [AdminTransactionController::class, 'void'])->name('transactions.void');
            Route::resource('transactions', AdminTransactionController::class)->only(['index', 'store', 'show', 'edit', 'update']);
            ...
            Route::resource('feedback', OperationalFeedbackController::class)->only(['index', 'show']);
